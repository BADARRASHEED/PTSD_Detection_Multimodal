...
const Working: React.FC = () => {
  return (
    <section className="w-full py-16 bg-white" id="working">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-12 px-6">
          ...
          <div className="flex flex-col items-center bg-teal-50 p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">
              Admin grants access to doctors to securely upload patient videos
              for analysis.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center bg-teal-50 p-8 rounded-lg shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-teal-600 mb-4">
              Doctors Upload Videos
            </h3>
            <p className="text-gray-700">
              Doctors upload patient videos securely for analysis by the AI
              system.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center bg-teal-50 p-8 rounded-lg shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-teal-600 mb-4">
              AI Analyzes for PTSD Symptoms
            </h3>
            <p className="text-gray-700">
              AI analyzes the videos to detect PTSD symptoms through advanced
              video analysis.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center bg-teal-50 p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">
              The results of the analysis are shared securely with the doctor
              for review.
            </p>
          </div>
        </div>
