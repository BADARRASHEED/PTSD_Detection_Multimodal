        ...
        <div className="flex flex-col justify-center">
          ...
          <ul className="space-y-4 text-lg text-gray-700">
            <li className="flex items-center">
              <FaCheckCircle className="text-teal-600 mr-3" /> Early diagnosis
              and improved treatment plans
            </li>
            <li className="flex items-center">
              <FaCheckCircle className="text-teal-600 mr-3" /> Easy-to-use
              interface for doctors
            </li>
            <li className="flex items-center">
              <FaCheckCircle className="text-teal-600 mr-3" /> Ensures patient
